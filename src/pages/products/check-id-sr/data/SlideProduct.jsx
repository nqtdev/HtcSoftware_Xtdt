...
import img_camet from 'assets/image_products/check-id-sr/camera/5.webp'
import img_camy from 'assets/image_products/check-id-sr/camera/6.webp'
import img_camu from 'assets/image_products/check-id-sr/camera/7.webp'
import img_cami from 'assets/image_products/check-id-sr/camera/8.webp'
import img_camo from 'assets/image_products/check-id-sr/camera/9.webp'
import img_camp from 'assets/image_products/check-id-sr/camera/10.webp'
import img_cama from 'assets/image_products/check-id-sr/camera/11.webp'
...
import img_nocamt from 'assets/image_products/check-id-sr/un_camera/17.webp'
// 2 thiết bị
...
import img_alle from 'assets/image_products/check-id-sr/all/21.webp'

const SlideProductCam = [
  { slideContent: img_camq },
  { slideContent: img_camw },
  { slideContent: img_camet },
  { slideContent: img_camr },
  { slideContent: img_camy },
  { slideContent: img_came },
  { slideContent: img_camu },
  { slideContent: img_cami },
  { slideContent: img_camo },
  { slideContent: img_camp },
  { slideContent: img_cama }
]
const SlideProductNoCam = [
  ...
  { slideContent: img_nocamt }
]
const SlideProduct = [
  { slideContent: img_all },
  { slideContent: img_allw },
  { slideContent: img_allq },
  { slideContent: img_alle }
]
