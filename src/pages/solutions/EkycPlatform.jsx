      ...
      <section className='m-auto lg:w-4/5 mt-20'>
        ...
        <div className='grid gap-2 md:grid-cols-2 mx-auto'>
          ...
          >
            ...
            <span>
              <b className='text-main-colors'>Xác thực danh tính nhanh chóng:</b> Giảm thiểu thời
              gian xác thực so với phương pháp thủ công.
            </span>
          </div>
          <div
          ...
          >
            ...
            <span>
              <b className='text-main-colors'>Tăng cường bảo mật:</b> Sử dụng các phương pháp sinh
              trắc học như nhận dạng khuôn mặt và dấu vân tay.
            </span>
          </div>
          <div
          ...
          >
            ...
            <span>
              <b className='text-main-colors'>Tiết kiệm chi phí:</b> Giảm chi phí liên quan đến xử
              lý giấy tờ và nhân lực.
            </span>
          </div>
          <div
          ...
          >
            ...
            <span>
              <b className='text-main-colors'>Cải thiện trải nghiệm khách hàng:</b> Khách hàng có
              thể xác thực từ xa mà không cần đến trực tiếp.
            </span>
          </div>
          <div
            data-aos={isMobile ? 'fade-down' : 'zoom-out-right'}
          ...
          >
            ...
            <span>
              <b className='text-main-colors'>Tuân thủ quy định pháp luật:</b> Hiệu quả hơn trong
              việc tuân thủ các quy định về phòng chống rửa tiền và chống tài trợ khủng bố.
            </span>
          </div>
          <div
            data-aos={isMobile ? 'fade-down' : 'zoom-out-left'}
          ...
          >
            ...
            <span>
              <b className='text-main-colors'>Dữ liệu chính xác và minh bạch:</b> Thu thập và lưu
              trữ dữ liệu chính xác, dễ dàng truy xuất.
            </span>
          </div>
        </div>
      </section>
          ...
          >
            <div className='m-auto md:w-1/2'>
              <div className='flex items-center'>
                ...
                <h3 className='font-mulish font-bold text-[#3385ff]'>ID Reader (OCR)</h3>
              </div>
              <span className='font-mulish text-[#545f7a]'>
                OCR (Optical Character Recognition) được sử dụng để nhận dạng, quét ký tự bằng quang
                học thông qua hình ảnh hoặc tệp PDF với độ chính xác rất cao. Đây là công nghệ cần
                thiết để xây dựng luồng tiếp cận khách hàng Online (Digital Onboarding).
              </span>
              <div className='flex items-center'>
          ...
          >
            <div className='m-auto md:w-1/2'>
              <div className='flex items-center'>
                ...
                <h3 className='font-mulish font-bold text-[#3385ff]'>Liveness Check.</h3>
              </div>
              <span className='font-mulish text-[#545f7a]'>
                Liveness Check là công nghệ hỗ trợ doanh nghiệp phát hiện, ngăn chặn các trường hợp
                giả mạo (Fraud) khuôn mặt, hình ảnh, video.
              </span>
              <div className='flex items-center'>
                <img src={Star} alt='icon ngôi sao' />
                <span className='font-mulish font-medium text-gray-500'>
            ...
            <div className='md:w-1/2'>
              <img className='m-auto w-3/4' src={LiveNess_Check} alt='LiveNess_Check' />
            </div>
          </div>
          {/* ID Sannity Check  */}
          <div
          ...
          >
            <div className='m-auto md:w-1/2'>
              <div className='flex items-center'>
                ...
                <h3 className='font-mulish font-bold text-[#3385ff]'>ID Sanity Check</h3>
              </div>
              <span className='font-mulish text-[#545f7a]'>
              ...
              <div className='flex items-center'>
                ...
                <span className='font-mulish font-medium text-gray-500'>
                  Giải pháp ID Sanity Check được xây dựng với những thuật toán thị giác máy tính
                  (Computer Vision) tiên tiến, hiện đại.
                </span>
              </div>
              <div className='flex items-center'>
                <img src={Star} alt='icon ngôi sao' />
          ...
          >
            <div className='m-auto md:w-1/2'>
              <div className='flex items-center'>
                ...
                <h3 className='font-mulish font-bold text-[#3385ff]'>Xác minh CCCD gắn chip</h3>
              </div>
              <span className='font-mulish text-[#545f7a]'>
                Đọc và xác minh thông tin trên CCCD gắn chip sử dụng kết nối NFC. Từ đó, kiểm tra
                thông tin cá nhân khách hàng đã được xác thực bởi Bộ Công an một cách nhanh chóng và
                chính xác.
              </span>
              <div className='flex items-center'>
                <img src={Star} alt='icon ngôi sao' />
              ...
              <div className='flex items-center'>
                <img src={Star} alt='icon ngôi sao' />
                <span className='font-mulish font-medium text-gray-500'>
                  Đọc thông tin với độ chính xác tuyệt đồi (thông tin được lưu trong thẻ chip).
                </span>
              </div>
              <div className='flex items-center'>
                <img src={Star} alt='icon ngôi sao' />
